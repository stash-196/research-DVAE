...
def visualize_combined_metrics(delta_per_epoch, delta_threshold,
                               kl_warm_epochs, kl_warm_values,
                               auto_warm_epochs, auto_warm_values,
                               sequence_len_epochs, sequence_len_values,
                               cpt_patience_epochs, best_state_epochs, model_name, sampling_method, save_figures_dir, tag):
    plt.clf()
