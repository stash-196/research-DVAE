...
# The key is the experiment directory, and the value is the space-separated parameters.
declare -A experiments=(
    ["/flash/DoyaU/stash/research-DVAE/saved_model/2026-02-12/deigo_cluster/20260212_Lorenz_epoch10000_len1000_ptfAll_MissAll_clip1_LossNone_LSTM_hdi20_ptientHigh"]="sampling_ratio mask_label"
    ["/flash/DoyaU/stash/research-DVAE/saved_model/2026-02-12/deigo_cluster/20260212_Lorenz_epoch10000_len1000_ptfAll_MissAll_clip1_LossNone_MTRNN_hdi20_ptientHigh"]="sampling_ratio mask_label"
    ["/flash/DoyaU/stash/research-DVAE/saved_model/2026-02-12/deigo_cluster/20260212_Lorenz_len1000_drop0_ptf0.6-7-_clip1_AllLoss_LSTM_hdi20s_ptientHigh"]="sampling_ratio mask_label"
    ["/flash/DoyaU/stash/research-DVAE/saved_model/2026-02-12/deigo_cluster/20260212_Lorenz_len1000_drop0_ptf0.6-7-_clip1_AllLoss_MTRNN_hdi20-40_ptientHigh"]="sampling_ratio mask_label"

    # Add more key-value pairs here as needed: ["/path/to/exp"]="param1 param2"
)
...
for EXPERIMENT_DIR in "${!experiments[@]}"; do
    PARAMS="${experiments[$EXPERIMENT_DIR]}"

    if [ -z "$PARAMS" ]; then
        echo "[bash] Skipping entry with empty parameters for directory: $EXPERIMENT_DIR"
        continue
    fi
